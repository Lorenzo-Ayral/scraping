    ...
    try:
        ...
        for url in URLS:
            ...
            if url not in all_data:
                ...
                prompt=f"Régénère moi une description de produit plus originale et avec un ton amical, à partir de la description produit suivante : {infos['description']}"
                description_gpt = get_completion(prompt)

                all_data[url] = { "title": infos["title"], "description": infos["description"], "description_gpt": description_gpt, "records": {}}
